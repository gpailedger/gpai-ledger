...
# Data Summary for microsoft_phi-1_5 
...
**1.2.1 Versioned model name(s):** phi-1.5 

 

**1.2.2 Model release date:** 09-Oct-2023 
...
**1.3.1.B Text training data content:** Same data sources as phi-1, augmented with various NLP synthetic texts generated by gpt-3.5-turbo-0301. 
...
**1.3.2 Latest date of data acquisition/collection for model training:** 08/31/2023 
...
**1.3.4 Date the training dataset was first used to train the model:** 09/01/2023 

 

**1.3.5 Rationale or purpose of data selection:** Datasets focused on synthetic textbook-like texts and filtered code were chosen to teach common sense reasoning, general knowledge, and coding while reducing exposure to harmful web content. This supports research into safety, bias mitigation, and efficient learning using high-quality, curated data rather than generic web crawls 
